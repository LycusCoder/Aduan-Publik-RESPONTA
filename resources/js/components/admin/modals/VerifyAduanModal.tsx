...
interface VerifyAduanModalProps {
    open: boolean;
    onClose: () => void;
...
const VerifyAduanModal: React.FC<VerifyAduanModalProps> = ({
    open,
    onClose,
    onVerify,
    nomorTiket,
                                    ...
                                    <div className="mt-3 w-full text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                Verifikasi aduan <span className="font-semibold">{nomorTiket}</span>?
                                            </p>
                                        </div>
...
export default VerifyAduanModal;
